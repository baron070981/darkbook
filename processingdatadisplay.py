...
class DataProcess:
    ...
    def periods(self, datas:[var.Datas]=None):
        ...
        for dt in data:
            d[dt.mdate.year][dt.mdate.month][0]+=dt.money
    ...
    def set_allperiodsdata(self, datas:[var.Datas]=None):
        ...
        for data in newdatas:
            d[data.mdate.year][data.mdate.month][data.mdate.day].append([data.idd,data.money])
    ...
    def get_now_str(self):
        d = var.Datas()
        year = str(d.mdate.year)
        month = str(d.mdate.month)
        day = str(d.mdate.day)
        money = str(d.money)
